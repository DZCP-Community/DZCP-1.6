...
EAL.prototype.toggle = function (id, toggle_to) {
...
EAL.prototype.toggle_off = function (id) {
...
EAL.prototype.set_editarea_size_from_textarea = function (id, frame) {
    var elem = document.getElementById(id);
...
EAL.prototype.set_base_url = function () {
    if (!this.baseURL) {
...
EAL.prototype.get_button_html = function (id, img, exec, baseURL) {
...
EAL.prototype.get_control_html = function (button_name, lang) {
    ...
    switch (button_name) {
        ...
        case "select_font":
            html = "<select id='area_font_size' onchange='javascript:editArea.execCommand(\"change_font_size\")'>" + "			<option value='-1'>{$font_size}</option>" + "			<option value='8'>8 pt</option>" + "			<option value='9'>9 pt</option>" + "			<option value='10'>10 pt</option>" + "			<option value='11'>11 pt</option>" + "			<option value='12'>12 pt</option>" + "			<option value='14'>14 pt</option>" + "		</select>";
            return html;
    }
    return "<span id='tmp_tool_" + button_name + "'>[" + button_name + "]</span>";
};
EAL.prototype.get_template = function () {
    if (this.template == "") {
        var xhr_object = null;
...
EAL.prototype.translate = function (text, lang, mode) {
...
EAL.prototype.add_event = function (obj, name, handler) {
    if (obj.attachEvent) {
...
EAL.prototype.submit = function (e) {
    var formObj = eAL.nav['isIE'] ? window.event.srcElement : e.target;
    for (var i in eAs) {
        var is_child = false;
        for (var x = 0; x < formObj.elements.length; x++) {
...
EAL.prototype.getValue = function (id) {
...
EAL.prototype.setValue = function (id, new_val) {
    if (window.frames["frame_" + id] && eAs[id]["displayed"] == true) {
...
EAL.prototype.getSelectionRange = function (id) {
...
EAL.prototype.setSelectionRange = function (id, new_start, new_end) {
    if (window.frames["frame_" + id] && eAs[id]["displayed"] == true) {
...
EAL.prototype.getSelectedText = function (id) {
    var sel = this.getSelectionRange(id);
    return this.getValue(id).substring(sel["start"], sel["end"]);
};
EAL.prototype.setSelectedText = function (id, new_val) {
...
EAL.prototype.insertTags = function (id, open_tag, close_tag) {
...
EAL.prototype.hide = function (id) {
...
EAL.prototype.show = function (id) {
