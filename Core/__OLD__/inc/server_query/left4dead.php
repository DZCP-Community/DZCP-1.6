...
$server_name = 'Left 4 Dead';
$server_name_short = 'L4D';
$server_link = 'ut2004://{IP}:{S_PORT}';
$server_name_config = array('ut2004' => array('Unreal Tournament 2004', 'UT 2004'),
);

$server_link_config = array('ut2004' => 'ut2004://{IP}:{S_PORT}',
);

##############################################################################################################################

function server_query_left4dead($ip, $port, $q_port, $request)
{
