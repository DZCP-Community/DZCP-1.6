...
$server_name = 'Medal of Honor';
$server_name_short = 'MoH';
$server_link = 'moh://{IP}:{S_PORT}';
$server_name_config = array('mohaa' => array('Medal of Honor: Armed Assault', 'MoHAA'),
    'mohaabd' => array('Medal of Honor: Armed Assault Breakthrough', 'MoHAABD'),
    'mohaas' => array('Medal of Honor: Armed Assault Spearhead', 'MoHAAS'),
    'mohpa' => array('Medal of Honor: Pacific Assault', 'MoHPA'),
);

##############################################################################################################################

function server_query_medalofhonor($ip, $port, $q_port, $request)
{
    global $server_timeout;
    $q_port = empty($q_port) ? $port + 97 : $q_port;
