...
if(defined('_UserMenu')) {
    ...
    elseif(isset($_GET['edit']) && data("level",$userid) == 4 && !rootAdmin($userid) && (!data("dsgvo_lock",(int)$_GET['id']) && !rootAdmin($userid)))
        if(!data("dsgvo_lock",(int)$_GET['id']) && !rootAdmin($userid)) {
