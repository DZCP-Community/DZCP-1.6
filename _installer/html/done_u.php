<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td>
      ...
      <div style="text-align:center;"><img src="img/done.jpg" border="0" alt=""></div><br />
      Als n&auml;chstes sollten Sie sich evtl. neu <a href="../news/">einloggen</a> und dem Adminmenu zuwenden um die Konfigurationen zu &uuml;berbearbeiten.<br /><br />
        <span style="color:red"><b>Wichtig!</b></span> Entfernen Sie unverz&uuml;glich den Installationsordner '<b>/_installer</b>' von Ihrem Webserver und setzen Sie <b>CHMOD 644</b> f&uuml;r die Datei <i>./inc/mysql.php</i>!<br />
