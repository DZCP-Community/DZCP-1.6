...
<html>
<head>
    <title>deV!L`z Clanportal - Update</title>
        ...
        <tr>
            <td valign="top" height="1%">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><img src="img/u_01.gif" border="0" alt=""></td>
                        <td><img src="img/u_02.gif" border="0" alt=""></td>
                    </tr>
                </table>
            </td>
        </tr>
                    ...
                    <tr>
                        <td width="194" valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Released:</b> <?php echo _release; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Build:</b> <?php echo _build; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="255"></td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="https://www.dzcp.de" target="_blank">www.dzcp.de</a></td>
                                </tr>
                            </table>
                        </td>
                        <td valign="50"></td>
