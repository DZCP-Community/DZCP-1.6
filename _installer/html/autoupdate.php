<table width="100%" cellpadding="3" cellspacing="1">
    ...
    <tr>
        <td align="justify">
            ...
            Wir von DZCP.de m&ouml;chten dir eine M&ouml;glichkeit anbieten, deine EU-DSGVO-Vorlagen automatisch zu
            aktualisieren.<br><br>
            Hier werden wir einige Daten automatisch auf deinem Webspace ersetzen. <br><br><u>Hier ist eine Auflistung
                der Daten die ersetzt werden:</u><br><br>
            <b>"/inc/api.php" => "Die Schnittstelle zum DZCP.de Server um Aktualisierungen einspielen"</b><br>
            <b>"/inc/lang/languages/dsgvo/*.php" => "Das sind die Vorlagen der EU-DSGVO, vorliegend in mehreren
                Sprachen"</b><br><br>
