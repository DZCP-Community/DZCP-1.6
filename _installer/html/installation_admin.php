<table width="100%" cellpadding="3" cellspacing="1">
    ...
    <form action="install.php?action=database&amp;do=install" method="POST">
        <tr>
            ...
            <td><b>Nickname:</b></td>
            <td><input type="text" name="nick" value="<?php echo isset($_POST['nick']) ? $_POST['nick'] : ''; ?>"></td>
        </tr>
        <tr>
            <td><b>E-Mail:</b></td>
            ...
            <td><b>Passwort:</b></td>
            <td><input type="password" name="pwd" value="<?php echo isset($_POST['pwd']) ? $_POST['pwd'] : ''; ?>"></td>
        </tr>
        <tr>
            <td height="20"></td>
        </tr>
        <tr>
            <td colspan="4" class="info"><b>Hinweis:</b> Dieser Vorgang kann ggf. einige Sekunden dauern, achten Sie
                also bitte darauf, die Seite w&auml;hrend dessen nicht neu zu laden!
            </td>
        </tr>
        <tr>
            <td height="20"></td>
