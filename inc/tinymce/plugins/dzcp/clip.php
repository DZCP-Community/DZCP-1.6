...
<form name="source" onsubmit="saveContent();">
    <div id="clip">
        ...
        <b>{#dzcp.clip_link}:</b> <img src="../../../images/expand.gif" alt=""/> <input id="linkSource" type="text"
                                                                                        value="more"/>
        <textarea name="htmlSource" id="htmlSource" rows="15" cols="100"
                  style="width: 100%; height: 380px; font-family: 'Courier New',Courier,mono; font-size: 12px;"
