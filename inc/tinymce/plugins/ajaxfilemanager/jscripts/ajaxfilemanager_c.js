...
function doCreateFolder() {
    ...
    if (!pattern.test($(folder).val())) {
        ...
        var options = {
            dataType: 'json', url: getUrl('create_folder'), error: function (data, status, e) {
                alert(e);
...
function deleteDocuments(msgNoDocSelected, msgUnableToDelete, msgWarning, elements) {
    ...
    if (!isSelected) {
        ...
        var options = {
            dataType: 'json', url: getUrl('delete'), error: function (data, status, e) {
                alert(e);
            }, success: function (data) {
                if (typeof(data.error) == 'undefined') {
                    alert('Unexpected error.');
...
function doRename() {
    ...
    if (!pattern.test($('div#TB_window  #renameName').val())) {
        ...
        var options = {
            dataType: 'json', url: getUrl('rename'), error: function (data, status, e) {
                alert(e);
            }, success: function (data) {
                if (data.error != '') {
                    alert(data.error);
...
function repositionDocuments(msgNoDocSelected, formActionUrl, actionVal) {
    ...
    if (!isSelected) {
        ...
        var options = {
            dataType: 'json', error: function (data, status, e) {
                alert(e);
            }, success: function (data) {
                if (typeof(data.error) == 'undefined') {
                    alert('Unexpected Error');
