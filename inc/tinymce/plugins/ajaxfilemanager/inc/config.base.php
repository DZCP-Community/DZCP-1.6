...
define('CONFIG_SYS_DEFAULT_PATH', '../../../../inc/tinymce_files/'); //accept relative path only
define('CONFIG_SYS_ROOT_PATH', '../../../../inc/tinymce_files/');    //accept relative path only
...
define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,rar,zip'); // 
...
define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,rar,zip');
