<form action="../search/index.php" method="get" onsubmit="return DZCP.submitButton('searchSubmit')">
    <input type="hidden" name="action" value="site" />
      <table width="10" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><input type="text" id="searchpanel" name="searchword" value="{$searchword}"
     onfocus="if(this.value=='{$searchword}')this.value=''" onblur="if(this.value=='')this.value='{$searchword}'" /></td>
