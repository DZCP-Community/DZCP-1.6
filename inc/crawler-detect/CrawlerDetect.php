...
require_once(basePath.'/inc/crawler-detect/Fixtures/AbstractProvider.php');
require_once(basePath.'/inc/crawler-detect/Fixtures/Crawlers.php');
require_once(basePath.'/inc/crawler-detect/Fixtures/Exclusions.php');
require_once(basePath.'/inc/crawler-detect/Fixtures/Headers.php');
